...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::vector<float> >::type shape_ward_to_discharge(shape_ward_to_dischargeSEXP);
    Rcpp::traits::input_parameter< std::vector<float> >::type scale_ward_to_discharge(scale_ward_to_dischargeSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(mush_abc(n_samples, n_delay_samples, n_outputs, n_days, steps_per_day, thresholds_vec, rejections_per_selections, do_ABC, ensemble_curves, mat_pr_age_given_case, mat_pr_hosp, mat_pr_ICU, shape_ward_to_discharge, scale_ward_to_discharge, forecasting_parameters, known_ward_vec, known_ICU_vec, prior_sigma_los, prior_sigma_hosp));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_curvemush_mush_abc", (DL_FUNC) &_curvemush_mush_abc, 19},
    {NULL, NULL, 0}
};
